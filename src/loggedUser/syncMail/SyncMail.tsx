    ...
    return (
        <section>
          ...
          <div className="mt-24 lg:mx-[10%] mx-[2%]">
            ...
            Poniżej możesz zarządzać skrzynkami e-mail jakie są połączone z Twoim kontem. Jeśli chcesz usunąć adres e-mail spiety z naszą aplikacją, kliknij “usuń”. Jeśli chcesz dodać skrzynkę, naciśnij “+dodaj skrzynkę”.
Twój obecny pakiet to: [nazwa_pakietu]. Możesz połączyć jeszcze [ilość_skrzynek] z aplikacją.
            </div>
          ...
          <p>
          *aby skrzynka została aktywowana, kliknij w link aktywacyjny który został wysłany w wiadomości e-mail na Twoją skrzynkę.
          </p>
          <button className='bg-[#1A9367]'>
          + dodaj skrzynkę
          </button>
