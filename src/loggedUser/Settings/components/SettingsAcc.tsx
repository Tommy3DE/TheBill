  ...
  return (
    <section className="mx-auto">
      ...
      <div className="mx-auto max-w-[1980px] flex flex-col justify-center items-center">
        ...
        Zmień adres e-mail biura księgowego        </h1>
        <img src={acc} alt="hour" className="my-10 h-36" />
        <h2 className="text-2xl text-gray-700 text-center tracking-wider">
        Adres e-mail biura księgowego na który wysyłane są Twoje faktury:        </h2>
        
        <input type="text" className="w-1/4 bg-gray-300 text-black rounded-full py-2 my-10 text-center text-2xl  tracking-wider" value={accName} disabled={!isEditing}/>
        <button className="uppercase font-playFair text-2xl px-10 py-2 text-white bg-[#1A9367] mb-12 rounded-xl" onClick={()=>setIsEditing(prev=>!prev)}>
            Edytuj
        </button>
